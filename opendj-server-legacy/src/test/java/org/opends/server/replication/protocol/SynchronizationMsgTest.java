...
public class SynchronizationMsgTest extends ReplicationTestCase
{
         ...
         throws Exception
  {
    ...
    assertEquals(mod1.<Object>getAttachment(SYNCHROCONTEXT),
            mod2.<Object>getAttachment(SYNCHROCONTEXT));
         ...
         throws Exception
  {
    ...
    assertEquals(addOp.<Object>getAttachment(SYNCHROCONTEXT),
            genAddOp.<Object>getAttachment(SYNCHROCONTEXT));
